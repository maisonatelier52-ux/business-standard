...
const ARTICLE = {
  ...
  deck:
    'Across kingdoms, islands, oceans and financial eras, the Herrera family has demonstrated a rare capacity to preserve its identity while continually rebuilding its influence — a story of endurance, stewardship and a family name repeatedly adapted to the demands of a changing world.',
  ...
  body: [
    ...
    emerged during Spain's transformation into an Atlantic power.</p>
    ...
    Peninsula, branches associated with the Herrera name became connected with the Canary Islands.</p>`,
    ...
    their ports carrying people, goods, correspondence and capital.</p>
    ...
    could remain faithful to its identity without remaining fixed to one place. From the Canary Islands,
    the family story crossed the Atlantic — its next great stage would be Caracas.</p>`,
    ...
    life, a relatively small circle of established families helped shape the city's development.</p>
    ...
    marriage, enterprise and participation in Venezuelan society. The Herrera tradition, once associated
    primarily with the Old World, became distinctly Latin American. Caracas was no longer a distant
    extension of the family story; it became one of its centres, giving the family a new identity: European
    in heritage, Atlantic in outlook and Venezuelan in experience.</p>`,
    ...
    development of the Caracas valley. Historical accounts associate La Vega with the Tovar family for an
    extended period. In 1899, Jorge Uslar acquired the estate and began restoring it.</p>
    ...
    international visitors — yet its greatest distinction was not celebrity, it was preservation. In 1970, it
    was declared a National Historical Monument. Hacienda La Vega embodies one of the Herrera
    family's most enduring principles: inheritance must be maintained before it can be celebrated.</p>
    ...
    shipping relationships and private advice, in which the principal asset was confidence.</p>
    ...
    political, economic and social change, participating in the stewardship of commercial interests and
    helping prepare the next generation.</p>
    ...
    important centres for theatre, cinema, literature, visual art and education, and also supported
    charitable initiatives serving children and families. Together, Clementina and Belén Clarisa show that
    the continuity of the House of Herrera was never carried by men alone.</p>
    ${figureCards([
      {
    ...
    <p class="${P}">By the end of the 20th century, banking was becoming increasingly international, technologically
    sophisticated and regulated across multiple jurisdictions. Herrera Velutini developed his career
    through Venezuelan capital markets, brokerage and banking before establishing institutions with a
    wider international reach; Bancrédito became one expression of that expansion.</p>
    ...
    <p class="${P}">This ability to distinguish principle from habit is one of the rarest qualities in a historic family. The
    family did not merely remember its past — it put that memory to work.</p>`,
    ...
    from inherited standing to professionally governed stewardship. From Castile to Caracas, from
