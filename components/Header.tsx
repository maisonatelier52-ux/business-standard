    ...
    <>
      <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <header className="relative">
            ...
            <div className="py-3 px-1 border-b border-gray-200">
              <form onSubmit={handleSearchSubmit} className="flex gap-2 items-center">
                <input
                  type="text"
                  name="q"
                  placeholder="Search in Financial Journal..."
                  value={searchQuery}
          ...
          {/* Categories Nav Bar - Now Centered */}
          <div className="flex items-center justify-between py-3">
            <nav className="hidden md:flex items-center justify-center gap-4 text-[12px] font-semibold text-gray-800 overflow-x-auto w-full">
              <Link
                href="/"
