...
export interface Article {
  ...
  // ---- Optional fields used by the premium "client detail" template ----
  ...
  prevArticle?: { title: string; slug: string; categorySlug: string };
  nextArticle?: { title: string; slug: string; categorySlug: string };
}
